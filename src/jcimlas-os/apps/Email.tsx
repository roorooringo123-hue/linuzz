...
const INITIAL_EMAILS: Email[] = [
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Meeting notes from today',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Security alert for your repository',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Project update - Phase 2 complete',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Your weekly tech digest',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Lunch next week?',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Your order has shipped!',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Code review feedback',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'New releases this month',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Happy New Year!',
  ...
  {
    id: '11', from: 'Security Team', fromEmail: 'security@jcimlasos.local',
    to: ['user@jcimlasos.local'], subject: 'Important: Password reset required',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'You won a prize!',
  ...
  {
    id: '13', from: 'me', fromEmail: 'user@jcimlasos.local',
  ...
  {
    id: '14', from: 'me', fromEmail: 'user@jcimlasos.local',
  ...
  {
    id: '15', from: 'me', fromEmail: 'user@jcimlasos.local',
  ...
  },
  {
    ...
    to: ['user@jcimlasos.local'], subject: 'Last month\'s deals',
...
const ComposeModal = memo(function ComposeModal({ onClose, onSend }: { onClose: () => void; onSend: (email: Omit<Email, 'id' | 'date' | 'isRead' | 'isStarred' | 'labels'>) => void }) {
  ...
  const handleSend = () => {
    ...
    onSend({ from: 'me', fromEmail: 'user@jcimlasos.local', to: [to], subject, body, folder: 'sent' });
    onClose();
  };
