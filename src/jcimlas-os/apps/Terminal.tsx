...
import { useFileSystem } from '@/jcimlas-os/hooks/useFileSystem';
...
const COMMANDS: Record<string, (args: string[], ctx: TerminalContext) => string | string[]> = {
  ...
  uname: () => 'jcimlasOS Web 1.0.0-generic x86_64',
  ...
  neofetch: () => [
    ...
    '',
    '\x1b[36mOS:\x1b[0m jcimlasOS Web 1.0.0',
    '\x1b[36mKernel:\x1b[0m browser-engine-20.0',
    '\x1b[36mShell:\x1b[0m jcimlasshell 1.0',
    '\x1b[36mDE:\x1b[0m GNOME-like Web Desktop',
    '\x1b[36mTheme:\x1b[0m Adwaita-dark [GTK2/3]',
    '\x1b[36mIcons:\x1b[0m jcimlas-mono-dark [GTK2/3]',
    '\x1b[36mTerminal:\x1b[0m jcimlasterminal',
...
export default function Terminal() {
  ...
  const [lines, setLines] = useState<TerminalLine[]>([
    { type: 'system', text: 'Welcome to jcimlasOS Terminal' },
